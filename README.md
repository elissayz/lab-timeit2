...
| -------------- | ------------------------- | --------------------- | 
| `n=2**0`       |          0.515 usec       |          1.3 usec     |
| `n=2**1`       |          0.825 usec       |       1.69 usec       |
| `n=2**2`       |           1.16 usec       |       1.74 usec       |
| `n=2**3`       |          0.968 usec       |       1.97 usec       |
| `n=2**4`       |          1.11 usec        |       2.27 usec       |
| `n=2**5`       |          1.53 usec        |       2.4 usec        |
| `n=2**6`       |          1.43 usec        |       2.51 usec       |
| `n=2**7`       |          2.11 usec        |       2.51 usec       |
| `n=2**8`       |          2.06 usec        |       2.97 usec       |
| `n=2**9`       |          2.8 usec         |       3.75 usec       |
| `n=2**10`      |          8.92 usec        |       4.02 usec       |
| `n=2**11`      |          20.1 usec        |       3.91 usec       |
| `n=2**12`      |          39.6 usec        |       4.37 usec       |
| `n=2**13`      |          63.9 usec        |       4.62 usec       |
| `n=2**14`      |          129 usec         |       4.78 usec       |
| `n=2**15`      |          350 usec         |       5.38 usec       |
| `n=2**16`      |          674 usec         |       10.2 usec       |
| `n=2**17`      |          1.16 msec        |       5.85 usec       |
| `n=2**18`      |          2.32 msec        |       6.67 usec       |
| `n=2**19`      |          4.64 msec        |       9.42 usec       |
| `n=2**20`      |          8.95 msec        |       10.2 usec       |
| `n=2**21`      |          20.2 msec        |       7.64 usec       |
| `n=2**22`      |          38.1 msec        |       8.13 usec       |
...
| -------------------------- | ---------| --------|------------ | ------------- |
| `sequential_search_itr`    | 6.7 msec |1.25 msec| 1.05 msec   | 1.33 msec     |
| `sequential_search_itr2`   |9.23 msec |2.1 msec | 2.51 msec   | 98 msec       |
| `sequential_search_rec`    |  ---     | ---     |  ---        |  ---          |
| `binary_search_itr`        | 9.8 usec |2.71 usec| 2.53 usec   |  150 usec     |
| `binary_search_rec`        | 10.2 usec|4.89 usec| 2.34 usec   |  162 usec     |
| `binary_search_rec2`       |9.29 usec | 334 usec| 453 usec    |  ---          |
